...
insert into tenant(id,name,description) values(nextval('hibernate_sequence'),'TENANT_1','AGH');
insert into tenant(id,name,description) values(nextval('hibernate_sequence'),'TENANT_2','Uniwersytet Jagiellonski');
insert into tenant(id,name,description) values(nextval('hibernate_sequence'),'TENANT_3','Politechnika Krakowska');
